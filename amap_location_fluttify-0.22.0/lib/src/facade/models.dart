...
class GeoFence {
  ...
  final String? ohosModel;

  GeoFence.android(this.androidModel) : this.iosModel = null, this.ohosModel = null;

  GeoFence.ios(this.iosModel) : this.androidModel = null, this.ohosModel = null;

  GeoFence.ohos(this.ohosModel) : this.androidModel = null, this.iosModel = null;
