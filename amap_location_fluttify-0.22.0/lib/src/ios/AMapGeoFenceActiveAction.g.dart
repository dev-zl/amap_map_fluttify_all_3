...
extension AMapGeoFenceActiveActionFromX on int {
  AMapGeoFenceActiveAction toAMapGeoFenceActiveAction() {
    switch (this) {
      ...
      case const (1<<0): return AMapGeoFenceActiveAction.AMapGeoFenceActiveActionInside;
      case const (1<<1): return AMapGeoFenceActiveAction.AMapGeoFenceActiveActionOutside;
      case const (1<<2): return AMapGeoFenceActiveAction.AMapGeoFenceActiveActionStayed;
