...
extension AMapGeoFenceRegionActiveStatusFromX on int {
  AMapGeoFenceRegionActiveStatus toAMapGeoFenceRegionActiveStatus() {
    switch (this) {
      ...
      case const (1<<0): return AMapGeoFenceRegionActiveStatus.AMapGeoFenceRegionActiveMonitoring;
      case const (1<<1): return AMapGeoFenceRegionActiveStatus.AMapGeoFenceRegionActivePaused;
